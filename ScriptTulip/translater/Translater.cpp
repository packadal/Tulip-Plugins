...
QString Translater::parse(const QString& script)
{
	...
	// Footer
	result += "\n    return true;\n  }\n};\n\nALGORITHMPLUGIN(GeneratedPlugin, \"Generated Plugin\", \"Generated by Script Translator (c) XP Team\", \"20/03/09\", \"No Comment\", \"1.0\");\n\n";
...
QString Translater::addLine(QString line) {
	...
	// new removal if needed
	QRegExp regExpNew("new\\s+(QColor|QVariant|QString)");
	if (line.contains(regExpNew))
		line.replace(regExpNew, "\\1");        
