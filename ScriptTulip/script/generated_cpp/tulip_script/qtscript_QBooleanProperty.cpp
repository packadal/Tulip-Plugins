...
static const char * const qtscript_QBooleanProperty_function_names[] = {
    "QBooleanProperty"
    // static
    // prototype
    , "toString"
...
static const char * const qtscript_QBooleanProperty_function_signatures[] = {
    "QGraph arg__1"
    // static
    // prototype
""
...
static const int qtscript_QBooleanProperty_function_lengths[] = {
    1
    // static
    // prototype
    , 0
...
static QScriptValue qtscript_QBooleanProperty_throw_ambiguity_error_helper(
    QScriptContext *context, const char *functionName, const char *signatures)
{
    ...
    return context->throwError(QString::fromLatin1("QBooleanProperty::%0(): could not find a function match; candidates are:\n%1")
        .arg(functionName).arg(fullSignatures.join(QLatin1String("\n"))));
}

Q_DECLARE_METATYPE(QBooleanProperty*)
Q_DECLARE_METATYPE(QtScriptShell_QBooleanProperty*)
...
static QScriptValue qtscript_QBooleanProperty_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    QBooleanProperty* _q_self = qscriptvalue_cast<QBooleanProperty*>(context->thisObject());
    if (!_q_self) {
        return context->throwError(QScriptContext::TypeError,
            QString::fromLatin1("QBooleanProperty.%0(): this object is not a QBooleanProperty")
            .arg(qtscript_QBooleanProperty_function_names[_id+1]));
    }

    switch (_id) {
    case 0: {
    QString result = QString::fromLatin1("QBooleanProperty");
    ...
    return qtscript_QBooleanProperty_throw_ambiguity_error_helper(context,
        qtscript_QBooleanProperty_function_names[_id+1],
        qtscript_QBooleanProperty_function_signatures[_id+1]);
}

static QScriptValue qtscript_QBooleanProperty_static_call(QScriptContext *context, QScriptEngine *)
{
    uint _id = context->callee().data().toUInt32();
    Q_ASSERT((_id & 0xFFFF0000) == 0xBABE0000);
    _id &= 0x0000FFFF;
    ...
    if (context->thisObject().strictlyEquals(context->engine()->globalObject())) {
        return context->throwError(QString::fromLatin1("QBooleanProperty(): Did you forget to construct with 'new'?"));
    }
    ...
    return qtscript_QBooleanProperty_throw_ambiguity_error_helper(context,
        qtscript_QBooleanProperty_function_names[_id],
