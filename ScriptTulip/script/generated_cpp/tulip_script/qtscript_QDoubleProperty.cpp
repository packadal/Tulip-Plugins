...
static const char * const qtscript_QDoubleProperty_function_names[] = {
    "QDoubleProperty"
    // static
    // prototype
    , "toString"
...
static const char * const qtscript_QDoubleProperty_function_signatures[] = {
    "QGraph g"
    // static
    // prototype
""
...
static const int qtscript_QDoubleProperty_function_lengths[] = {
    1
    // static
    // prototype
    , 0
...
static QScriptValue qtscript_QDoubleProperty_throw_ambiguity_error_helper(
    QScriptContext *context, const char *functionName, const char *signatures)
{
    ...
    return context->throwError(QString::fromLatin1("QDoubleProperty::%0(): could not find a function match; candidates are:\n%1")
        .arg(functionName).arg(fullSignatures.join(QLatin1String("\n"))));
}

Q_DECLARE_METATYPE(QDoubleProperty*)
Q_DECLARE_METATYPE(QtScriptShell_QDoubleProperty*)
...
static QScriptValue qtscript_QDoubleProperty_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    QDoubleProperty* _q_self = qscriptvalue_cast<QDoubleProperty*>(context->thisObject());
    if (!_q_self) {
        return context->throwError(QScriptContext::TypeError,
            QString::fromLatin1("QDoubleProperty.%0(): this object is not a QDoubleProperty")
            .arg(qtscript_QDoubleProperty_function_names[_id+1]));
    }

    switch (_id) {
    case 0: {
    QString result = QString::fromLatin1("QDoubleProperty");
    ...
    return qtscript_QDoubleProperty_throw_ambiguity_error_helper(context,
        qtscript_QDoubleProperty_function_names[_id+1],
        qtscript_QDoubleProperty_function_signatures[_id+1]);
}

static QScriptValue qtscript_QDoubleProperty_static_call(QScriptContext *context, QScriptEngine *)
{
    uint _id = context->callee().data().toUInt32();
    Q_ASSERT((_id & 0xFFFF0000) == 0xBABE0000);
    _id &= 0x0000FFFF;
    ...
    if (context->thisObject().strictlyEquals(context->engine()->globalObject())) {
        return context->throwError(QString::fromLatin1("QDoubleProperty(): Did you forget to construct with 'new'?"));
    }
    ...
    return qtscript_QDoubleProperty_throw_ambiguity_error_helper(context,
        qtscript_QDoubleProperty_function_names[_id],
